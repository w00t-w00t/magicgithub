...
/**
 * Class that generates fake users statically.
 */
public abstract class FakeApiServiceGenerator {
    ...
    /**
     * Generates a initial fake users list.
     * @return the fake users.
     */
    ...
    /**
     * Generates a random users list
     * (that the user will be allowed to add the initial list displayed).
     *
